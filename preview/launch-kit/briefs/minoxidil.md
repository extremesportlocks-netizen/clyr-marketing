...
## CLYR Hair Regrowth Spray (Men)

**Document:** Launch Kit · minoxidil  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | CLYR Hair Regrowth Spray (Men) |
| **Pharmacy dispense name** | Minoxdil/Tretinoin/Fluocinolone/Finasteride Spray |
| **Standard strength (CLYR pick)** | 7/0.025/0.025/0.2% |
| **Package** | 60ml |
| **Page (live/preview)** | [www.clyr.health/preview/products/minoxidil.html](https://www.clyr.health/preview/products/minoxidil.html) |
...
4-mechanism hair spray men

**Competitive anchor (retail market):** Hims 5% minox $45/mo
...
1. Confirm **Minoxdil/Tretinoin/Fluocinolone/Finasteride Spray** available at quoted wholesale
2. Confirm strength **7/0.025/0.025/0.2%** as default SKU (single offering per CLYR page)
