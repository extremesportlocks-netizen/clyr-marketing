...
**Document:** Launch Kit · estradiol-vaginal-cream  
**Brand:** CLYR Health (www.clyr.health)  
**Status:** PREVIEW  
**Vertical:** Women's Hormone  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Estradiol Vaginal Cream |
| **Pharmacy dispense name** | Estradiol Vaginal Topical Cream |
| **Standard strength (CLYR pick)** | 0.01% (1mg/g) |
| **Package** | 30g |
| **Page (live/preview)** | [www.clyr.health/preview/products/estradiol-vaginal-cream.html](https://www.clyr.health/preview/products/estradiol-vaginal-cream.html) |
| **Marketing brief** | [Pharmacy brief](https://www.clyr.health/preview/launch-kit/briefs/estradiol-vaginal-cream.html) |
...
**Competitive anchor (retail market):** Premarin-class $40–80/mo
...
| Metric | Target |
|---|---|
| **Projected patients at scale** | 200+ pts/mo |
...
### Target patient
Peri/menopausal women 40–65

### Key messages
• Bioidentical depth competitors lack

• GLP-1 cross-sell (weight + hormones)

• No Midi-style membership lock-in

### Cross-sell paths
GLP-1 women → HRT → Skin longevity → NAD face cream

### Go-live requirements from pharmacy
1. Confirm **Estradiol Vaginal Topical Cream** available at quoted wholesale
2. Confirm strength **0.01% (1mg/g)** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on 30g
