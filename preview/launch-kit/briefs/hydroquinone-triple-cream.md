...
## Hydroquinone Triple Cream

**Document:** Launch Kit · hydroquinone-triple-cream  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Hydroquinone Triple Cream |
| **Pharmacy dispense name** | Hydroquionone/Tretinoin/Fluocinolone Acetonide |
| **Standard strength (CLYR pick)** | Standard triple combo |
| **Package** | 30g |
| **Page (live/preview)** | https://www.clyr.health/hydroquinone-triple-cream.html |
| **Marketing brief** | https://www.clyr.health/preview/launch-kit/briefs/hydroquinone-triple-cream.html |
...
Prescription hyperpigmentation

**Competitive anchor (retail market):** Derm compound $60–90
...
### Target patient
Adults 18–55 acne and hair loss

### Key messages
• Multi-mechanism topicals (not plain minox)

• CLYR Tri Gel proprietary 503A

• Pharmacy-depth vs Hims single-ingredient

### Cross-sell paths
Acne: Tri Gel + Doxycycline; Hair: spray + finasteride; Longevity: NAD cream

### Go-live requirements from pharmacy
1. Confirm **Hydroquionone/Tretinoin/Fluocinolone Acetonide** available at quoted wholesale
2. Confirm strength **Standard triple combo** as default SKU (single offering per CLYR page)
