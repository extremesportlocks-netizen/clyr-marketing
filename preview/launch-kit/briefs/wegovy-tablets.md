...
**Document:** Launch Kit · wegovy-tablets  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Wegovy Tablets |
...
Oral brand GLP-1 — needle-free

**Competitive anchor (retail market):** Brand cash pricing
...
| Metric | Target |
|---|---|
| **Projected patients at scale** | 50+ pts/mo |
...
1. Confirm **Oral semaglutide brand** available at quoted wholesale
2. Confirm strength **Per FDA oral label** as default SKU (single offering per CLYR page)
