...
**Document:** Launch Kit · testosterone-cypionate  
**Brand:** CLYR Health (www.clyr.health)  
**Status:** PREVIEW  
**Vertical:** Men's Hormone  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Testosterone Cypionate |
| **Pharmacy dispense name** | Testosterone Cypionate 200mg/ml x 10ml |
| **Standard strength (CLYR pick)** | 200mg/ml |
| **Package** | 10ml vial |
| **Page (live/preview)** | https://www.clyr.health/testosterone-cypionate.html |
| **Marketing brief** | https://www.clyr.health/preview/launch-kit/briefs/testosterone-cypionate.html |
...
Primary TRT injectable — highest margin vertical

**Competitive anchor (retail market):** Hone/Marek $120–249/mo
...
| Metric | Target |
|---|---|
| **Projected patients at scale** | 400+ pts/mo |
...
### Target patient
Men 35–65 with low-T symptoms, fertility-preserving segment

### Key messages
• Full TRT stack in one platform

• No $25/mo membership (Hone model)

• Enclomiphene + HCG alternatives

### Cross-sell paths
Weight loss men → TRT → Sexual health → Peptides

### Go-live requirements from pharmacy
1. Confirm **Testosterone Cypionate 200mg/ml x 10ml** available at quoted wholesale
2. Confirm strength **200mg/ml** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on 10ml vial
