...
**Document:** Launch Kit · tadalafil-troches  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Tadalafil Troches |
| **Pharmacy dispense name** | Tadalafil 22mg Troches x 8 |
| **Standard strength (CLYR pick)** | 22mg |
| **Package** | 8 troches |
| **Page (live/preview)** | [www.clyr.health/preview/products/tadalafil-troches.html](https://www.clyr.health/preview/products/tadalafil-troches.html) |
...
Sublingual on-demand ED

**Competitive anchor (retail market):** Compounding $60–90/mo
...
| Metric | Target |
|---|---|
| **Projected patients at scale** | 250+ pts/mo |
...
1. Confirm **Tadalafil 22mg Troches x 8** available at quoted wholesale
2. Confirm strength **22mg** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on 8 troches
