...
**Document:** Launch Kit · dhea-pregnenolone  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | DHEA + Pregnenolone |
| **Pharmacy dispense name** | DHEA/Pregnenolone compounded |
| **Standard strength (CLYR pick)** | Per protocol |
| **Package** | 30-count |
| **Page (live/preview)** | [www.clyr.health/preview/products/dhea-pregnenolone.html](https://www.clyr.health/preview/products/dhea-pregnenolone.html) |
...
**Competitive anchor (retail market):** Longevity/HRT crossover
...
1. Confirm **DHEA/Pregnenolone compounded** available at quoted wholesale
2. Confirm strength **Per protocol** as default SKU (single offering per CLYR page)
