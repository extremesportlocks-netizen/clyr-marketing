...
**Document:** Launch Kit · estradiol-patches  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Estradiol Patches |
| **Pharmacy dispense name** | Estradiol 0.05 mg / Day Patch x 8pack |
| **Standard strength (CLYR pick)** | 0.05mg/day |
| **Package** | 8-pack |
| **Page (live/preview)** | https://www.clyr.health/estradiol-patches.html |
| **Marketing brief** | https://www.clyr.health/preview/launch-kit/briefs/estradiol-patches.html |
...
Transdermal HRT foundation

**Competitive anchor (retail market):** Midi/Alloy $80–120/mo
...
1. Confirm **Estradiol 0.05 mg / Day Patch x 8pack** available at quoted wholesale
2. Confirm strength **0.05mg/day** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on 8-pack
