...
## CLYR Hair Regrowth Spray (Women)

**Document:** Launch Kit · hair-spray-women  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | CLYR Hair Regrowth Spray (Women) |
...
| **Package** | 60ml |
| **Page (live/preview)** | [www.clyr.health/preview/products/hair-spray-women.html](https://www.clyr.health/preview/products/hair-spray-women.html) |
...
Finasteride-free women's stack

**Competitive anchor (retail market):** Women's minox competitors
...
| Metric | Target |
|---|---|
| **Projected patients at scale** | 300+ pts/mo |
...
1. Confirm **Minoxidil/Tretinoin/Fluocinolone/Biotin/Melatonin Spray** available at quoted wholesale
2. Confirm strength **7/0.025/0.025/0.8/0.5%** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on 60ml
