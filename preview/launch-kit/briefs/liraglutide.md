...
**Document:** Launch Kit · liraglutide  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Liraglutide |
| **Pharmacy dispense name** | Liraglutide Olympia |
| **Standard strength (CLYR pick)** | Up to 3mg daily |
| **Package** | Multi-dose pen/vial |
| **Page (live/preview)** | https://www.clyr.health/liraglutide.html |
| **Marketing brief** | https://www.clyr.health/preview/launch-kit/briefs/liraglutide.html |
...
Alternative GLP-1 for sema-intolerant

**Competitive anchor (retail market):** Saxenda-class $300+
...
| Metric | Target |
|---|---|
| **Projected patients at scale** | 75+ pts/mo |
...
1. Confirm **Liraglutide Olympia** available at quoted wholesale
2. Confirm strength **Up to 3mg daily** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on Multi-dose pen/vial
