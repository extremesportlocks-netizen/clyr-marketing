...
**Document:** Launch Kit · ghk-cu-injectable  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | GHK-Cu Injectable |
| **Pharmacy dispense name** | GHK-Cu injectable |
| **Standard strength (CLYR pick)** | 1–2mg daily typical |
| **Package** | Vial |
| **Page (live/preview)** | [www.clyr.health/preview/products/ghk-cu-injectable.html](https://www.clyr.health/preview/products/ghk-cu-injectable.html) |
...
Copper peptide collagen support

**Competitive anchor (retail market):** Med spa injectables
...
1. Confirm **GHK-Cu injectable** available at quoted wholesale
2. Confirm strength **1–2mg daily typical** as default SKU (single offering per CLYR page)
