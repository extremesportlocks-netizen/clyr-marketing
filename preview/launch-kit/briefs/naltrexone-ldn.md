...
**Document:** Launch Kit · naltrexone-ldn  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Low-Dose Naltrexone |
| **Pharmacy dispense name** | Naltrexone Capsule compounded LDN |
| **Standard strength (CLYR pick)** | 4.5mg |
| **Package** | 90-count |
| **Page (live/preview)** | https://www.clyr.health/naltrexone-ldn.html |
| **Marketing brief** | https://www.clyr.health/preview/launch-kit/briefs/naltrexone-ldn.html |
...
LDN wellness protocol

**Competitive anchor (retail market):** LDN specialists $45–75/mo
...
### Target patient
LDN and wellness protocol patients

### Key messages
• Niche loyalty community

• Provider-gated protocols

### Cross-sell paths
Wellness → LDN; Ivermectin patient trust transfer

### Go-live requirements from pharmacy
1. Confirm **Naltrexone Capsule compounded LDN** available at quoted wholesale
2. Confirm strength **4.5mg** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on 90-count
