...
**Document:** Launch Kit · metformin-er  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Metformin ER |
| **Pharmacy dispense name** | Metformin ER |
| **Standard strength (CLYR pick)** | 500mg |
| **Package** | 90-count |
| **Page (live/preview)** | [www.clyr.health/preview/products/metformin-er.html](https://www.clyr.health/preview/products/metformin-er.html) |
...
GLP-1 companion / insulin sensitivity

**Competitive anchor (retail market):** Generic $10–20/mo retail
...
1. Confirm **Metformin ER** available at quoted wholesale
2. Confirm strength **500mg** as default SKU (single offering per CLYR page)
