...
| Field | Specification |
|---|---|
| **CLYR brand name** | Tretinoin Cream |
| **Pharmacy dispense name** | Tretinoin Cream |
| **Standard strength (CLYR pick)** | 0.025% |
| **Package** | 45g |
| **Page (live/preview)** | [www.clyr.health/preview/products/tretinoin.html](https://www.clyr.health/preview/products/tretinoin.html) |
...
**Competitive anchor (retail market):** Curology/derm $30–60/mo
...
1. Confirm **Tretinoin Cream** available at quoted wholesale
2. Confirm strength **0.025%** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on 45g
