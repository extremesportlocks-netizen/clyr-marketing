...
| Field | Specification |
|---|---|
| **CLYR brand name** | Tadalafil + Vardenafil |
...
Daily dual PDE5 — live CLYR SKU

**Competitive anchor (retail market):** Hims/Rugiet $30–99/mo
...
| Metric | Target |
|---|---|
| **Projected patients at scale** | 500+ pts/mo |
...
1. Confirm **Tadalafil compounded daily** available at quoted wholesale
2. Confirm strength **2.5–5mg daily class** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on 30 tablets
