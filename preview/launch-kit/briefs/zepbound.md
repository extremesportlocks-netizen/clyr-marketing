...
Brand-name tirzepatide option

**Competitive anchor (retail market):** Cash pay $500+/mo
...
1. Confirm **Mounjaro/Zepbound brand pen** available at quoted wholesale
2. Confirm strength **2.5–15mg weekly** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on Brand pen
