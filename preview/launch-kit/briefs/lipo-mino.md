...
## Lipo-Mino + L-Carnitine

**Document:** Launch Kit · lipo-mino  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Lipo-Mino + L-Carnitine |
...
GLP-1 companion lipotropic

**Competitive anchor (retail market):** Med spa bundles
...
1. Confirm **Lipo-Mino Olympia injection** available at quoted wholesale
2. Confirm strength **Per vial protocol** as default SKU (single offering per CLYR page)
