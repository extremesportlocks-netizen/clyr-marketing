...
**Document:** Launch Kit · niagen  
**Brand:** CLYR Health (www.clyr.health)  
**Status:** PREVIEW  
**Vertical:** Daily Wellness  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Injectable Niagen |
| **Pharmacy dispense name** | Niagen 100mg/ml - 5ml Vial Olympia |
| **Standard strength (CLYR pick)** | 100mg/ml |
| **Package** | 5ml vial |
| **Page (live/preview)** | https://www.clyr.health/niagen.html |
| **Marketing brief** | https://www.clyr.health/preview/launch-kit/briefs/niagen.html |
...
NAD+ precursor (NR) — pairs NAD+ page

**Competitive anchor (retail market):** NR supplements $50–80/mo
...
### Target patient
Health optimizers 35–65, longevity-focused

### Key messages
• Injectable cofactors and peptides

• Provider-monitored protocols

• Pairs with weight loss outcomes

### Cross-sell paths
GLP-1 patient → NAD+ → Sermorelin → Glutathione

### Go-live requirements from pharmacy
1. Confirm **Niagen 100mg/ml - 5ml Vial Olympia** available at quoted wholesale
2. Confirm strength **100mg/ml** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on 5ml vial
