...
| Field | Specification |
|---|---|
| **CLYR brand name** | HCG Injection |
| **Pharmacy dispense name** | Chorionic Gonadotropin - HCG (Fresenius Kabi) |
| **Standard strength (CLYR pick)** | 10,000 IU |
| **Package** | Vial |
| **Page (live/preview)** | [www.clyr.health/preview/products/hcg.html](https://www.clyr.health/preview/products/hcg.html) |
...
TRT adjunct / fertility

**Competitive anchor (retail market):** TRT clinics $99–149/mo
...
1. Confirm **Chorionic Gonadotropin - HCG (Fresenius Kabi)** available at quoted wholesale
2. Confirm strength **10,000 IU** as default SKU (single offering per CLYR page)
