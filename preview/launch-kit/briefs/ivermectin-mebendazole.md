...
**Document:** Launch Kit · ivermectin-mebendazole  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Ivermectin + Mebendazole |
...
Broader antiparasitic coverage

**Competitive anchor (retail market):** N/A niche
...
### Target patient
Protocol-motivated patients, provider-directed

### Key messages
• Niche trust vertical

• Provider-supervised antiparasitic protocols

### Cross-sell paths
Protocol patient → full wellness catalog

### Go-live requirements from pharmacy
1. Confirm **Ivermectin + Mebendazole combined** available at quoted wholesale
2. Confirm strength **25mg/250mg** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on 30 capsules
