...
| Field | Specification |
|---|---|
| **CLYR brand name** | Trimix Injection |
...
Injectable ED rescue therapy

**Competitive anchor (retail market):** Compounding pharmacies $80–150/mo
...
1. Confirm **TRIMIX T105** available at quoted wholesale
2. Confirm strength **30mg/1mg/10mcg per 0.1ml** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on 2.5ml vial
