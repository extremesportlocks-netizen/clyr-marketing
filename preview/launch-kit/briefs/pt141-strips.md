...
**Document:** Launch Kit · pt141-strips  
...
Alternative libido format

**Competitive anchor (retail market):** Novel format
...
1. Confirm **PT141 Strip** available at quoted wholesale
2. Confirm strength **Per strip protocol** as default SKU (single offering per CLYR page)
...
5. Custom branding request (if applicable): CLYR label on Strips
