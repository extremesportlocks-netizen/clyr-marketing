...
**Document:** Launch Kit · anastrozole  
...
| Field | Specification |
|---|---|
| **CLYR brand name** | Anastrozole |
| **Pharmacy dispense name** | Anastrozole 0.5mg Capsules |
| **Standard strength (CLYR pick)** | 0.5mg |
| **Package** | 30-count |
| **Page (live/preview)** | [www.clyr.health/preview/products/anastrozole.html](https://www.clyr.health/preview/products/anastrozole.html) |
...
**Competitive anchor (retail market):** Bundled TRT $15–30/mo
...
1. Confirm **Anastrozole 0.5mg Capsules** available at quoted wholesale
2. Confirm strength **0.5mg** as default SKU (single offering per CLYR page)
