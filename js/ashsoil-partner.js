...
(function () {
  ...
  if (cards[0]) {
    ...
    if (cta0) {
      ...
      cta0.innerHTML = 'Start 30-day cleanse <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>';
    }
  ...
  if (cards[1]) {
    ...
    if (cta1) {
      ...
      cta1.innerHTML = 'Start dual cleanse <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>';
    }
