...
PRODUCTS = [
    ...
    # Men's Hormone / TRT
    ("testosterone-cypionate", "Testosterone Cypionate", "Men's Hormone · TRT", "mens-hormone", "Men's Hormone", "TRT", "Injectable testosterone cypionate for clinically low testosterone. Compounded from your Olympia TRT menu — provider-supervised dosing and lab monitoring.", "Testosterone Cypionate injectable", ["Restores physiologic T levels", "Weekly or biweekly injection protocols", "Highest-margin hormone vertical"], "/img/vial-sermorelin-new.png"),
    ("testosterone-cream", "Testosterone Cream", "Men's Hormone · TRT", "mens-hormone", "Men's Hormone", "Topical", "Transdermal testosterone 1% cream — 30g tube. Needle-free alternative for patients who prefer topical delivery.", "Testosterone 1% (10mg/gm) Cream - 30g", ["Daily topical application", "Steady absorption profile", "Pairs with enclomiphene or HCG"], "/img/cardv2/glutathione.webp"),
    ("testosterone-hypo-spray", "Testosterone Hypo Spray", "Men's Hormone · TRT", "mens-hormone", "Men's Hormone", "HypoSpray", "Metered testosterone hypospray — rapid transdermal delivery without injections. Multiple strengths on pharmacy menu.", "Testosterone Hypo Spray 12–14ml", ["No needle protocol option", "Precise metered dosing", "Differentiator vs Hims/Ro shallow TRT"], "/img/cardv2/nad.webp"),
    ("enclomiphene", "Enclomiphene", "Men's Hormone · Fertility", "mens-hormone", "Men's Hormone", "Fertility+", "Enclomiphene citrate — stimulates endogenous testosterone while preserving fertility. Alternative to exogenous TRT for appropriate candidates.", "Enclomiphene", ["Raises LH/FSH-driven T production", "Preserves sperm production", "Growing telehealth demand"], "/img/cardv2/pill-tadalafil-tad25-new.webp"),
    ("hcg", "HCG Injection", "Men's Hormone · Adjunct", "mens-hormone", "Men's Hormone", "HCG", "Chorionic gonadotropin (HCG) — TRT adjunct, monotherapy, or fertility support. Fresenius Kabi / Pregnyl options on menu.", "Chorionic Gonadotropin - HCG", ["Testicular function support on TRT", "Fertility preservation", "Monotherapy option"], "/img/vial-nad-new.png"),
    ("anastrozole", "Anastrozole", "Men's Hormone · Support", "mens-hormone", "Men's Hormone", "AI", "Anastrozole for estrogen management on testosterone therapy. Provider-prescribed aromatase inhibitor.", "Anastrazole", ["Estrogen balance on TRT", "Provider-monitored dosing", "Complete hormone stack"], "/img/cardv2/pill-tadalafil-tad25-new.webp"),
    # Women's HRT
    ("estradiol-patches", "Estradiol Patches", "Women's Hormone · HRT", "womens-hormone", "Women's Hormone", "HRT", "Transdermal estradiol patches for menopausal symptom relief — steady hormone delivery from your HRT catalog.", "Estradiol Patches", ["Gold-standard transdermal HRT", "Steady estradiol levels", "39-SKU HRT menu depth"], "/img/cardv2/glutathione.webp"),
    ("biest-progesterone-cream", "Biest + Progesterone Cream", "Women's Hormone · HRT", "womens-hormone", "Women's Hormone", "Compounded", "Bi-estrogen (50:50 estriol/estradiol) with progesterone cream — compounded menopause support.", "Biestrogen / Progesterone cream", ["Bioidentical hormone combination", "Custom strength compounding", "Midi/Alloy competitor counter"], "/img/cardv2/glutathione.webp"),
    ("progesterone-capsules", "Progesterone Capsules", "Women's Hormone · HRT", "womens-hormone", "Women's Hormone", "HRT", "Oral micronized progesterone for endometrial protection and sleep support in HRT protocols.", "Progesterone Capsule", ["Endometrial protection on estrogen", "Sleep and mood support", "Standard HRT pairing"], "/img/cardv2/pill-tadalafil-tad25-new.webp"),
    ("dhea-pregnenolone", "DHEA + Pregnenolone", "Women's Hormone · Longevity", "womens-hormone", "Women's Hormone", "Precursors", "DHEA and pregnenolone combination — adrenal hormone precursors for aging and vitality support.", "DHEA/Pregnenolone", ["Adrenal hormone precursors", "Longevity crossover SKU", "Pairs with NAD+ / Niagen"], "/img/cardv2/nad.webp"),
    ("estradiol-vaginal-cream", "Estradiol Vaginal Cream", "Women's Hormone · HRT", "womens-hormone", "Women's Hormone", "Local", "Low-dose estradiol vaginal cream for genitourinary syndrome of menopause (GSM).", "Estradiol Vaginal Topical Cream", ["Local GSM relief", "Minimal systemic exposure", "High patient demand"], "/img/cardv2/glutathione.webp"),
    ("womens-testosterone-cream", "Women's Testosterone Cream", "Women's Hormone · Libido", "womens-hormone", "Women's Hormone", "Libido", "Low-dose testosterone cream for women — libido and energy support when clinically appropriate.", "Women Testosterone cream", ["Female androgen insufficiency", "Libido + energy crossover", "Sexual health + HRT bridge"], "/img/cardv2/pt141-odt-rose.webp"),
    # Sexual wellness depth
    ("trimix", "Trimix Injection", "Sexual Health · ED", "sexual-health", "Sexual Health", "Trimix", "Trimix (alprostadil/papaverine/phentolamine) injectable for severe ED when oral PDE5 inhibitors are insufficient.", "Trimix T105/T106", ["Rescue therapy for refractory ED", "High pharmacy margin", "37 sexual wellness SKUs — you sell 4"], "/img/cardv2/pill-tadalafil-tad25-new.webp"),
    ("tadalafil-apomorphine", "Tadalafil + Apomorphine", "Sexual Health · ED", "sexual-health", "Sexual Health", "Dual", "Tadalafil + apomorphine troches — PDE5 plus dopamine agonist for on-demand erectile response.", "Tadalafil+Apomorphine Troches", ["Dual-mechanism on-demand", "Extends combo ODT story", "Differentiator vs single-ingredient"], "/img/cardv2/sild-tadal-oxy-square.webp"),
    ("oxytocin-nasal", "Oxytocin Nasal Spray", "Sexual Health · Bonding", "sexual-health", "Sexual Health", "Oxytocin", "Oxytocin nasal spray for intimacy, connection, and arousal support — pairs with PT-141 line.", "Oxytocin Nasal Spray", ["Bonding and arousal support", "Cross-sell with PT-141 ODT", "Unique pharmacy SKU"], "/img/cardv2/pt141-odt-rose.webp"),
    ("tadalafil-troches", "Tadalafil Troches", "Sexual Health · ED", "sexual-health", "Sexual Health", "Troche", "Sublingual tadalafil troches — 22mg rapid-absorption ED option from pharmacy menu.", "Tadalafil 22mg Troches x 8", ["Sublingual absorption", "On-demand flexibility", "Expands beyond daily tablet"], "/img/cardv2/pill-tadalafil-tad25-new.webp"),
    ("sildenafil-tadalafil-gummy", "Sildenafil + Tadalafil Gummy", "Sexual Health · ED", "sexual-health", "Sexual Health", "Dual Gummy", "Dual PDE5 gummy — sildenafil 40mg / tadalafil 10mg. On-demand with your existing gummy UX.", "Sildenafil 40mg / Tadalafil 10mg Gummy x 8", ["Two PDE5s one dose", "Matches your gummy brand", "High conversion format"], "/img/cardv2/gummy-sildenafil-square.webp"),
    # Metabolic / GLP-1 innovation
    ("semaglutide-odt", "Semaglutide ODT + Ondansetron", "Weight Loss · Oral", "weight-loss", "Weight Loss", "Anti-Nausea", "Oral semaglutide ODT with ondansetron built in — nausea-managed GLP-1 from your pharmacy menu.", "Semaglutide / Ondansetron ODT", ["Nausea managed in formulation", "Oral GLP-1 innovation layer", "Only platform with brand + compound + ODT"], "/img/cardv2/foundayo-bottle.webp"),
    ("tirzepatide-sublingual", "Tirzepatide Sublingual Drops", "Weight Loss · Oral", "weight-loss", "Weight Loss", "Sublingual", "Tirzepatide sublingual drops — needle-free GLP-1/GIP option for needle-averse patients.", "Tirzepatide sublingual drops", ["Needle-free tirzepatide", "Expands three-door pricing story", "Pharmacy menu exclusive"], "/img/cardv2/tirzepatide.webp"),
    ("metformin-er", "Metformin ER", "Weight Loss · Metabolic", "weight-loss", "Weight Loss", "Metabolic", "Metformin extended-release for insulin sensitivity and GLP-1 companion therapy.", "Metformin ER", ["GLP-1 companion therapy", "Insulin sensitivity support", "Low-cost metabolic anchor"], "/img/cardv2/pill-tadalafil-tad25-new.webp"),
    ("liraglutide", "Liraglutide", "Weight Loss · GLP-1", "weight-loss", "Weight Loss", "GLP-1", "Liraglutide injection — established GLP-1 for weight management, alternative to sema/tirz.", "Liraglutide Olympia", ["Established GLP-1 option", "Saxenda-class therapy compounded", "Depth vs competitors"], "/img/cardv2/semaglutide.webp"),
    # Skin care depth
    ("nad-face-cream", "NAD+ Face Cream", "Skin & Hair · Anti-Aging", "skin-hair", "Skin & Hair", "10% NAD", "10% NAD+ pump face cream — topical cellular energy for skin, pairs with injectable NAD+ line.", "NAD+ Pump Face Cream", ["Topical NAD+ delivery", "Longevity + skin crossover", "Unique vs med spas"], "/img/cardv2/nad.webp"),
    ("tretinoin", "Tretinoin Cream", "Skin & Hair · Anti-Aging", "skin-hair", "Skin & Hair", "Retinoid", "Prescription tretinoin — gold-standard retinoid for photoaging, acne maintenance, and skin turnover.", "Tretinoin cream", ["Gold-standard retinoid", "Acne + anti-aging bridge", "26 skin SKUs available"], "/img/cardv2/glutathione.webp"),
    ("estriol-ghk-cu-cream", "Estriol + GHK-Cu Cream", "Skin & Hair · Anti-Aging", "skin-hair", "Skin & Hair", "Peptide", "Estriol / niacinamide / GHK-Cu / hyaluronic acid cream — compounded anti-aging stack.", "Estriol /Niacinamide/GHK-Cu /Hyaluronic Acid Cream", ["Four-mechanism topical", "Women's longevity crossover", "Med spa competitor counter"], "/img/cardv2/glutathione.webp"),
    ("hydroquinone-triple-cream", "Hydroquinone Triple Cream", "Skin & Hair · Pigmentation", "skin-hair", "Skin & Hair", "Brightening", "Hydroquinone / tretinoin / fluocinolone — prescription hyperpigmentation and melasma protocol.", "Hydroquionone/Tretinoin/Fluocinolone Acetonide", ["Prescription brightening", "Dermatology-grade compound", "High demand SKU"], "/img/cardv2/glutathione.webp"),
    ("doxycycline-acne", "Doxycycline (Acne)", "Skin & Hair · Acne", "skin-hair", "Skin & Hair", "Oral", "Oral doxycycline for moderate inflammatory acne — pairs with CLYR Tri Gel topical stack.", "Doxycycline Capsules", ["Systemic acne support", "Pairs with CLYR Tri Gel", "Complete acne vertical"], "/img/cardv2/pill-tadalafil-tad25-new.webp"),
    # Peptides / wellness expansion
    ("bpc-157", "BPC-157", "Daily Wellness · Peptides", "peptides", "Peptides & Recovery", "Peptide", "BPC-157 peptide injection — tissue repair and gut-joint recovery support, growing peptide demand.", "BPC-157 injection", ["Tissue repair peptide", "Recovery + performance niche", "36 wellness SKUs depth"], "/img/vial-sermorelin-new.png"),
    ("tb-500", "TB-500", "Daily Wellness · Peptides", "peptides", "Peptides & Recovery", "Peptide", "Thymosin beta-4 (TB-500) — recovery and flexibility peptide from wellness catalog.", "TB-500 / Thymosin Beta-4", ["Recovery peptide", "Athletic + longevity crossover", "Provider-supervised"], "/img/vial-sermorelin-new.png"),
    ("ghk-cu-injectable", "GHK-Cu Injectable", "Daily Wellness · Peptides", "peptides", "Peptides & Recovery", "Copper", "GHK-Cu injectable — copper peptide for collagen synthesis and tissue remodeling.", "GHK-Cu injectable", ["Collagen remodeling", "Pairs with topical GHK cream", "Peptide stack depth"], "/img/vial-nad-new.png"),
    ("pt141-strips", "PT-141 Strips", "Sexual Health · Libido", "sexual-health", "Sexual Health", "Strip", "PT-141 sublingual strips — on-demand libido support, alternative format to your ODT.", "PT141 Strip", ["Alternative to ODT format", "On-demand libido", "37 sexual SKUs — expand"], "/img/cardv2/pt141-odt-rose.webp"),
    # Hair + recovery
    ("finasteride-oral", "Finasteride Oral", "Skin & Hair · Hair", "skin-hair", "Skin & Hair", "DHT Block", "Oral finasteride 1mg for androgenetic alopecia — systemic DHT block, pairs with topical sprays.", "Finasteride", ["Systemic DHT reduction", "Pairs with 7% spray stacks", "Complete hair vertical"], "/img/cardv2/pill-tadalafil-tad25-new.webp"),
    ("naltrexone-ldn", "Low-Dose Naltrexone", "Recovery · Wellness", "recovery", "Recovery & Wellness", "LDN", "Low-dose naltrexone (LDN) — autoimmune, chronic pain, and wellness protocol from substance-use catalog.", "Naltrexone Capsule", ["LDN wellness protocol", "Niche loyalty vertical", "Provider-monitored"], "/img/cardv2/pill-tadalafil-tad25-new.webp"),
]
